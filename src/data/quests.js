  ...
  },
  {
    id: 'craft', name: 'Trade and craft', jobs: [
      ...
      Q('research', 'Unlock 2 upgrades', 2, 460, 24,
        ...
        'Every one of those is a job you never do again.', 'Factory → tap the Harbour Computer', { ico: 'lab' }),
      ...
      Q('forge', 'Forge a dish', 1, 900, 40,
        ...
        'Better bowl, better price. Told you.', 'The Wheel, on the rail', { g: 'plates', id: 'plate_b01' }),
